...
handlers_file=$new_package/config/handlers.yaml
sed -i -e "s/template_custom_commands_package/$response/g" $handlers_file

tmp_launch_file=$new_package/launch/template_custom_commands_package
target_launch_file=$new_package/launch/$response.launch
mv $tmp_launch_file $target_launch_file

sed -i -e "s/template_custom_commands_package/$response/g" $target_launch_file
