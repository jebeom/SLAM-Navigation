...
class MoveBaseActionInterface(CommandActionInterface):
    def __init__(self, name, parameters):
        self.args_description = ['x', 'y', 'theta', 'frame_id']
        self.args_types = [float, float, float, str]
        self.args_void_allowed = [False, False, False, True]
        self.default_values = ["robot_map"]
        self.output_types = []
