...
from robot_simple_command_manager.parser.lists import GPSCoordinateList


class GoToGPSProcedureInterface(CommandProcedureInterface):
    def __init__(self, name, parameters):
        # frame,  max_vel, [lat,lon lat,lon ...],
        self.args_description = ['frame', 'max_vel', '[lat,lon lat,lon ...]']
        self.args_types = [str, float, GPSCoordinateList]
