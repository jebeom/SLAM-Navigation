...
if (getenv('ROBOT_HMI_2D_SENSOR_1') == false) {
    $ROBOT_HMI_2D_SENSOR_1 = "throttle/front_laser/scan";
    // Warning console message in browser
    echo "<script>console.warn('ROBOT_HMI_2D_SENSOR_1 not set, using default: " . $ROBOT_HMI_2D_SENSOR_1 . "')</script>";
} else {
    $ROBOT_HMI_2D_SENSOR_1 = "throttle/".getenv('ROBOT_HMI_2D_SENSOR_1');
}
...
$robot_dictionary["topic_scan"] = $robot_dictionary["prefix"]."/".$ROBOT_HMI_2D_SENSOR_1;
$robot_dictionary["topic_front_camera"]= $robot_dictionary["prefix"]."/front_rgbd_camera/rgb/image_rect_color";
$robot_dictionary["topic_2d_scan"]= $robot_dictionary["prefix"]."/".$ROBOT_HMI_2D_SENSOR_1;
