...
The cartographer_pbstream_creator package, based on RComponent structure. Auxiliar node that offers a service to generate Cartographer pbstream maps. The service returns inmediately without feedback to avoid blocking the caller thread execution
