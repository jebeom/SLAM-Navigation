...
bool SummitXController::initController(ros::NodeHandle root_nh,
  ...
  controller_nh.param("applied_cmd_vel", applied_command_topic_,
  ...
  applied_cmd_vel_pub_ =
         root_nh.advertise<geometry_msgs::Twist>(applied_command_topic_, 1);
...
void SummitXController::update(const ros::Time& time,
  ...
  // actual cmd vel applied, limited by kinematics or 0 if robot is safe/emcy
  // stop
